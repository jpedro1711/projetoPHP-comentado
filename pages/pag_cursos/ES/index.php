    ...
    <div class="container">
      ...
      <section class="section">
        <div class="container-content">
          <div class="txt">
            <?php
              ...
              $sql = "SELECT nome,link,descricao FROM cursos WHERE nome like 'Engenharia de software'";
        ...
        <div class="mentores">
          <?php
            include '../connection.php';
            $sql = "SELECT mentores.nome, mentores.descricao, mentores.email FROM mentores
            INNER JOIN cursos
            on mentores.cod_curso = cursos.id
